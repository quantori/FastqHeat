...
class TestInputESEARCH_EFETCHParams:
    ...
    def test_get_run_uid_with_no_exception_with_total_list(self):
        time.sleep(1)
        webenv, query_key = get_webenv_and_query_key_with_total_list("SRP163674")
    ...
    def test_get_webenv_and_query_key_with_total_list_incorrect(self):
        ...
        with pytest.raises(SystemExit):
            get_webenv_and_query_key_with_total_list("ahethaerhatef")
    ...
    def test_get_run_uid_with_only_list(self):
        ...
        assert get_run_uid_with_only_list(
            ...
            ['SRR7969880', 'SRR7969881', 'SRR7969882', 'SRR7969883'],
            [50623, 29433, 36017, 20063],
        )
...
class TestENADataRetriaval:
    ...
    def test_get_total_spots_with_only_list(self):
        ...
        total_spots = get_total_spots_with_only_list(
            ['SRR7969880', 'SRR7969881', 'SRR7969882', 'SRR7969883']
        )
    ...
    def test_get_total_spots_with_only_list_incorrect(self):
        ...
        assert (
            get_total_spots_with_only_list(
                ['gasgweagveasdv', 'SRR7969881', 'SRR7969882', 'SRR7969883']
            )
            == []
        )
        ...
        mock_metadata = [
            {
                ...
                'experiment_accession': 'SRX4803380',
                'base_count': '22674621',
            },
            {
                'run_accession': 'SRR7969881',
                'experiment_accession': 'SRX4803379',
                'base_count': '13180909',
            },
            {
                'run_accession': 'SRR7969882',
                'experiment_accession': 'SRX4803378',
                'base_count': '16173418',
            },
            {
                'run_accession': 'SRR7969883',
                'experiment_accession': 'SRX4803377',
                'base_count': '8993061',
            },
        ]
        metadata = get_full_metadata(
            ['SRR7969880', 'SRR7969881', 'SRR7969882', 'SRR7969883'],
            "experiment_accession,base_count",
        )
    ...
    def test_get_full_metadata_incorrect(self):
        ...
        with pytest.raises(SystemExit):
            get_full_metadata(
                ['ghf,ckck', 'SRR7969881', 'SRR7969882', 'SRR7969883'],
                "experiment_accession,  base_count",
            )
